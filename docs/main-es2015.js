...
let AppComponent = class AppComponent {
    ...
    convertComponentToYML(component) {
        this.writeHeading();
    ...
    writeAnswer(component) {
        if (component.answer && component.khmerAnswer) {
            const jsonOptions = this.splitAndReturnAnswers(component);
            this.jsonLabel["english"][component.fieldId] = Object.assign({}, this.jsonLabel["english"][component.fieldId], { "options": Object.assign({}, jsonOptions[0]) });
            this.jsonLabel["khmer"][component.fieldId] = Object.assign({}, this.jsonLabel["khmer"][component.fieldId], { "options": Object.assign({}, jsonOptions[1]) });
        }
    }
    splitAndReturnAnswers(component) {
    ...
    writeKhhmerLabel(component) {
        this.jsonLabel["khmer"][component.fieldId] = Object.assign({}, this.jsonLabel["khmer"][component.fieldId], { "label": component.khmerLabel });
    }
    writeLabel(component) {
        this.writeYml('label: "' + component.question + '"');
        this.jsonLabel["english"][component.fieldId] = Object.assign({}, this.jsonLabel["english"][component.fieldId], { "label": component.question });
    }
    writeHeading() {
    ...
    writeValidationCondition(validaion) {
        switch (validaion) {
            case 'Mandatory':
...
module.exports = __webpack_require__(/*! /Users/raviteja/Documents/JSONTOYML/src/main.ts */"./src/main.ts");
